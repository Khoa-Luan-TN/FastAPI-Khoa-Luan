...
def debug_score(
    ...
    with driver.session() as neo:
        ...
        score_debug["topic_name"]  = debug_topic_name_scores(neo, plan, class_ids)
        score_debug["lesson_name"] = debug_lesson_name_scores(neo, plan, topic_ids, class_ids)
        score_debug["chunk_name"]  = debug_chunk_name_scores(neo, plan, lesson_ids, topic_ids, class_ids)
        score_debug["keyword"]     = debug_keyword_scores(neo, plan, resolved)
