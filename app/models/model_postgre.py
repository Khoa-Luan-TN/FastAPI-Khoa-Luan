...
# - Keyword: PK là keyword_id — sinh bởi trigger PostgreSQL BEFORE INSERT ('kw_' || keyword_slug)
...
class Keyword(Base):
    ...
    # keyword_id được sinh bởi trigger BEFORE INSERT của PostgreSQL theo dạng
    # 'kw_' || keyword_slug. Dùng server_default=FetchedValue() để SQLAlchemy đọc lại giá trị sau INSERT.
    keyword_id = Column(String, primary_key=True, index=True, server_default=FetchedValue())
