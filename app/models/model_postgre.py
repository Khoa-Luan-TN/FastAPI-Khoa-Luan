...
class Keyword(Base):
    ...
    # keyword_id is generated by a PostgreSQL BEFORE INSERT trigger as 'kw_' || keyword_slug.
    # Use server_default=FetchedValue() so SQLAlchemy reads back the generated value after INSERT.
